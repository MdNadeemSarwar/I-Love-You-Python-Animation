...
def curve():
    t.pen(pencolor="white", pensize=3, speed=15)
    for i in range(200):
        t.rt(1)
        t.fd(1)

def love_sign():
    t.pen(pencolor="white",fillcolor="hot pink", pensize=3, speed=50)
    t.shape("turtle")
    t.shapesize(1,1,1)
    t.begin_fill()
    t.lt(50)
...
# ================="O"=================
t.pen(pencolor="white",fillcolor="pink", pensize=3, speed=8)
t.begin_fill()
